...
typedef enum
{
    HA_FFMPEG_EVENT_STATUS_CHANGE = 0,                   /**<update status information by every frame*/ /**<CNcomment:״̬\D0\C5Ϣ\B8\FC\D0\C2, ÿ֡\B8\FC\D0\C2һ\B4\CE*/
